...
public class SearchItemsIT extends BaseIT {
    ...
    @Test
    public void notNullResultTest() throws InvalidText_Exception {
        List<ItemView> res = mediatorClient.searchItems("NO-MATCHES?");
        Assert.assertNotNull(res);
    }

    @Test
    public void anyResultTest() throws InvalidText_Exception {
        List<ItemView> res = mediatorClient.searchItems("NO-MATCHES");
    ...
    public void testCaseSensitivity() throws InvalidText_Exception {
        List<ItemView> res = mediatorClient.searchItems("GOOGLE PIXEL");
        Assert.assertEquals(0, res.size());
    }
    ...
    @Test
    public void oneResultTest() throws InvalidText_Exception {
        List<ItemView> res = mediatorClient.searchItems("Google Pixel C");
        Assert.assertEquals(1, res.size());
    }

    @Test
    public void allPrefixedResultsTest() throws InvalidText_Exception {
    ...
    @Test
    public void matchSomeResultsTest() throws InvalidText_Exception {
    ...
    @Test
    public void pricesSortedTest() throws InvalidText_Exception {
    ...
    @Test
    public void namesAndPricesSortedTest() throws InvalidText_Exception {
        List<ItemView> res = mediatorClient.searchItems("iPhone 6");
    ...
    @Test
    public void allNamesAndPricesSortedTest() throws InvalidText_Exception {
